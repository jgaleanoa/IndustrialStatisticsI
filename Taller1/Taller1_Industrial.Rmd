...
Según [1], se tiene el siguiente intervalo de confianza para $S^2$
...
Luego, se usa como alternativa tomar raiz tanto a ambos extremos del intervalo
como a la línes central obteniendo el lo siguiente para la gráfica de control de $s$.
...
Ahora, se puede detectar la existencia de dos subgrupos que no se residen en 
